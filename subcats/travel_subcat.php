...
<head>
  ...
  <title>Travel Polls - BackYourself</title>
  <style>
    .category-text {
...
<body>
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-8 main-content d-flex flex-column justify-content-center align-items-center">
        <h2 class="category-text">Travel Subcategories:</h2>
        <div class="button-layout">
          <button id="button-1" class="btn btn-primary" onclick="toggleButton(1)">Modes of Transport</button>
          <button id="button-2" class="btn btn-primary" onclick="toggleButton(2)">All Destinations</button>
          <button id="button-3" class="btn btn-primary" onclick="toggleButton(3)">Beach Vacations</button>
          <button id="button-4" class="btn btn-primary" onclick="toggleButton(4)">Budget Travel</button>
          <button id="button-5" class="btn btn-primary" onclick="toggleButton(5)">Other</button>
  ...
  <script>
    ...
    function submitForm() {
      ...
      const url = `../feed.php?category=Travel&subcategory=${encodeURIComponent(selectedSubcategories)}`;
