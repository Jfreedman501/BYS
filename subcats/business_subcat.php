...
<head>
  ...
  <title>Business Polls - BackYourself</title>
  <style>
    .category-text {
...
<body>
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-8 main-content d-flex flex-column justify-content-center align-items-center">
        <h2 class="category-text">Business Subcategories:</h2>
        <div class="button-layout">
          <button id="button-1" class="btn btn-primary" onclick="toggleButton(1)">Entrepreneurship</button>
          <button id="button-2" class="btn btn-primary" onclick="toggleButton(2)">Startups</button>
          <button id="button-3" class="btn btn-primary" onclick="toggleButton(3)">Marketing + Advertising</button>
          <button id="button-4" class="btn btn-primary" onclick="toggleButton(4)">Finance</button>
          <button id="button-5" class="btn btn-primary" onclick="toggleButton(5)">Leadership</button>
  ...
  <script>
    ...
    function submitForm() {
      ...
      const url = `../feed.php?category=Business&subcategory=${encodeURIComponent(selectedSubcategories)}`;
