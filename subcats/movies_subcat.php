...
<head>
  ...
  <title>Movie Polls - BackYourself</title>
  <style>
    .category-text {
...
<body>
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-8 main-content d-flex flex-column justify-content-center align-items-center">
        <h2 class="category-text">Movie Subcategories:</h2>
        <div class="button-layout">
          <button id="button-1" class="btn btn-primary" onclick="toggleButton(1)">Actors</button>
          <button id="button-2" class="btn btn-primary" onclick="toggleButton(2)">Movies</button>
          <button id="button-3" class="btn btn-primary" onclick="toggleButton(3)">Characters</button>
          <button id="button-4" class="btn btn-primary" onclick="toggleButton(4)">Marvel</button>
          <button id="button-5" class="btn btn-primary" onclick="toggleButton(5)">Star Wars</button>
          <button id="button-6" class="btn btn-primary" onclick="toggleButton(6)">Pixar</button>
          <button id="button-7" class="btn btn-primary" onclick="toggleButton(7)">Horror</button>
          <button id="button-8" class="btn btn-primary" onclick="toggleButton(8)">Disney</button>
          <button id="button-9" class="btn btn-primary" onclick="toggleButton(9)">Other</button>
  ...
  <script>
    ...
    function submitForm() {
      ...
      const url = `../feed.php?category=Movies&subcategory=${encodeURIComponent(selectedSubcategories)}`;
