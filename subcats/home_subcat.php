...
<head>
  ...
  <title>Home Polls - BackYourself</title>
  <style>
    .category-text {
...
<div class="container-fluid">
    <div class="row">
      ...
      <div class="col-8 main-content d-flex flex-column justify-content-center align-items-center">
        <h2 class="category-text">Home + Decor Subcategories:</h2>
        <div class="button-layout">
          <button id="button-1" class="btn btn-primary" onclick="toggleButton(1)">Interior Design</button>
          <button id="button-2" class="btn btn-primary" onclick="toggleButton(2)">DIY Projects</button>
          <button id="button-3" class="btn btn-primary" onclick="toggleButton(3)">Home Organization</button>
          <button id="button-4" class="btn btn-primary" onclick="toggleButton(4)">Home Renovation</button>
          <button id="button-5" class="btn btn-primary" onclick="toggleButton(5)">Furniture + Accessories</button>
          <button id="button-6" class="btn btn-primary" onclick="toggleButton(6)">Gardening</button>
          <button id="button-7" class="btn btn-primary" onclick="toggleButton(7)">Other</button>
  ...
  <script>
    ...
    function submitForm() {
      ...
      const url = `../feed.php?category=Home + Decor&subcategory=${encodeURIComponent(selectedSubcategories)}`;
