...
<head>
  ...
  <title>Fashion Polls - BackYourself</title>
  <style>
    .category-text {
...
<body>
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-8 main-content d-flex flex-column justify-content-center align-items-center">
        <h2 class="category-text">Fashion Subcategories:</h2>
        <div class="button-layout">
          <button id="button-1" class="btn btn-primary" onclick="toggleButton(1)">Clothing Styles</button>
          <button id="button-2" class="btn btn-primary" onclick="toggleButton(2)">Accessories</button>
          <button id="button-3" class="btn btn-primary" onclick="toggleButton(3)">Designers</button>
          <button id="button-4" class="btn btn-primary" onclick="toggleButton(4)">Trends</button>
          <button id="button-5" class="btn btn-primary" onclick="toggleButton(5)">Beauty + Makeup</button>
          <button id="button-6" class="btn btn-primary" onclick="toggleButton(6)">Street Style</button>
  ...
  <script>
    ...
    function submitForm() {
      ...
      const url = `../feed.php?category=Fashion&subcategory=${encodeURIComponent(selectedSubcategories)}`;
