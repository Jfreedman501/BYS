...
<head>
  ...
  <title>Politics Polls - BackYourself</title>
  <style>
    .category-text {
...
<body>
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-8 main-content d-flex flex-column justify-content-center align-items-center">
        <h2 class="category-text">Politics Subcategories:</h2>
        <div class="button-layout">
          <button id="button-1" class="btn btn-primary" onclick="toggleButton(1)">U.S. Politics</button>
          <button id="button-2" class="btn btn-primary" onclick="toggleButton(2)">International Politics</button>
          <button id="button-3" class="btn btn-primary" onclick="toggleButton(3)">Political Ideologies</button>
          <button id="button-4" class="btn btn-primary" onclick="toggleButton(4)">Political Figures</button>
          <button id="button-5" class="btn btn-primary" onclick="toggleButton(5)">Political Activism</button>
          <button id="button-6" class="btn btn-primary" onclick="toggleButton(6)">Other</button>
  ...
  <script>
    ...
    function submitForm() {
      ...
      const url = `../feed.php?category=Politics&subcategory=${encodeURIComponent(selectedSubcategories)}`;
