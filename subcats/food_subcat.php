...
<head>
  ...
  <title>Food Polls - BackYourself</title>
  <style>
    .category-text {
...
<body>
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-8 main-content d-flex flex-column justify-content-center align-items-center">
        <h2 class="category-text">Food Subcategories:</h2>
        <div class="button-layout">
          <button id="button-1" class="btn btn-primary" onclick="toggleButton(1)">Desserts</button>
          <button id="button-2" class="btn btn-primary" onclick="toggleButton(2)">Italian Cuisine</button>
          <button id="button-3" class="btn btn-primary" onclick="toggleButton(3)">Asian Cuisine</button>
          <button id="button-4" class="btn btn-primary" onclick="toggleButton(4)">Mexican Cuisine</button>
          <button id="button-5" class="btn btn-primary" onclick="toggleButton(5)">Vegetarian + Vegan</button>
          <button id="button-6" class="btn btn-primary" onclick="toggleButton(6)">Healthy Eating</button>
          <button id="button-7" class="btn btn-primary" onclick="toggleButton(7)">Fast Food</button>
  ...
  <script>
    ...
    function submitForm() {
      ...
      const url = `../feed.php?category=Food&subcategory=${encodeURIComponent(selectedSubcategories)}`;
