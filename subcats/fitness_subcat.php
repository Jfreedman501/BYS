...
<head>
  ...
  <title>Fitness Polls - BackYourself</title>
  <style>
    .category-text {
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-8 main-content d-flex flex-column justify-content-center align-items-center">
        <h2 class="category-text">Fitness Subcategories:</h2>
        <div class="button-layout">
          <button id="button-1" class="btn btn-primary" onclick="toggleButton(1)">Cardio</button>
          <button id="button-2" class="btn btn-primary" onclick="toggleButton(2)">Strength Training</button>
          <button id="button-3" class="btn btn-primary" onclick="toggleButton(3)">Yoga & Pilates</button>
          <button id="button-4" class="btn btn-primary" onclick="toggleButton(4)">Workout Equipment</button>
