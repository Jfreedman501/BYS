...
<head>
  ...
  <title>Sports Polls - BackYourself</title>
  <style>
    .category-text {
...
<body>
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-8 main-content d-flex flex-column justify-content-center align-items-center">
        <h2 class="category-text">Sports Subcategories:</h2>
        <div class="button-layout">
          <button id="button-1" class="btn btn-primary" onclick="toggleButton(1)">Football</button>
          <button id="button-2" class="btn btn-primary" onclick="toggleButton(2)">Basketball</button>
          <button id="button-3" class="btn btn-primary" onclick="toggleButton(3)">Soccer</button>
          <button id="button-4" class="btn btn-primary" onclick="toggleButton(4)">Baseball</button>
          <button id="button-5" class="btn btn-primary" onclick="toggleButton(5)">Tennis</button>
          <button id="button-6" class="btn btn-primary" onclick="toggleButton(6)">Golf</button>
          <button id="button-7" class="btn btn-primary" onclick="toggleButton(7)">Cricket</button>
          <button id="button-8" class="btn btn-primary" onclick="toggleButton(8)">Olympics</button>
          <button id="button-9" class="btn btn-primary" onclick="toggleButton(9)">F1</button>
          <button id="button-10" class="btn btn-primary" onclick="toggleButton(10)">MMA</button>
          <button id="button-11" class="btn btn-primary" onclick="toggleButton(11)">Other</button>
  ...
  <script>
    ...
    function submitForm() {
      ...
      const url = `../feed.php?category=Sports&subcategory=${encodeURIComponent(selectedSubcategories)}`;
