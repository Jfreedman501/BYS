...
<head>
  ...
  <title>Music Polls - BackYourself</title>
  <style>
    .category-text {
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-8 main-content d-flex flex-column justify-content-center align-items-center">
        <h2 class="category-text">Music Subcategories:</h2>
        <div class="button-layout">
          <button id="button-1" class="btn btn-primary" onclick="toggleButton(1)">Pop</button>
          <button id="button-2" class="btn btn-primary" onclick="toggleButton(2)">Rock</button>
          <button id="button-3" class="btn btn-primary" onclick="toggleButton(3)">Hip-hop + Rap</button>
          <button id="button-4" class="btn btn-primary" onclick="toggleButton(4)">Country</button>
          <button id="button-5" class="btn btn-primary" onclick="toggleButton(5)">R&B + Soul</button>
          <button id="button-6" class="btn btn-primary" onclick="toggleButton(6)">Classical</button>
          <button id="button-7" class="btn btn-primary" onclick="toggleButton(7)">Jazz</button>
          <button id="button-8" class="btn btn-primary" onclick="toggleButton(8)">EDM</button>
