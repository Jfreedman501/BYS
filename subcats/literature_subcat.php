...
<head>
  ...
  <title>Literature Polls - BackYourself</title>
  <style>
    .category-text {
...
<body>
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-8 main-content d-flex flex-column justify-content-center align-items-center">
        <h2 class="category-text">Literature Subcategories:</h2>
        <div class="button-layout">
          <button id="button-1" class="btn btn-primary" onclick="toggleButton(1)">Fiction</button>
          <button id="button-2" class="btn btn-primary" onclick="toggleButton(2)">Nonfiction</button>
          <button id="button-3" class="btn btn-primary" onclick="toggleButton(3)">Classic Literature</button>
          <button id="button-4" class="btn btn-primary" onclick="toggleButton(4)">Poetry</button>
  ...
  <script>
    ...
    function submitForm() {
      ...
      const url = `../feed.php?category=Literature&subcategory=${encodeURIComponent(selectedSubcategories)}`;
