...
<head>
  ...
  <title>Art Polls - BackYourself</title>
  <style>
    .category-text {
...
<body>
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-8 main-content d-flex flex-column justify-content-center align-items-center">
        <h2 class="category-text">Arts Subcategories:</h2>
        <div class="button-layout">
          <button id="button-1" class="btn btn-primary" onclick="toggleButton(1)">Painting</button>
          <button id="button-2" class="btn btn-primary" onclick="toggleButton(2)">Sculpture</button>
          <button id="button-3" class="btn btn-primary" onclick="toggleButton(3)">Photography</button>
          <button id="button-4" class="btn btn-primary" onclick="toggleButton(4)">Digital Art</button>
          <button id="button-5" class="btn btn-primary" onclick="toggleButton(5)">Architecture</button>
  ...
  <script>
    ...
    function submitForm() {
      ...
      const url = `../feed.php?category=Arts&subcategory=${encodeURIComponent(selectedSubcategories)}`;
