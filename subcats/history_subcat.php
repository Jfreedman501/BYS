...
<head>
  ...
  <title>History Polls - BackYourself</title>
  <style>
    .category-text {
...
<body>
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-8 main-content d-flex flex-column justify-content-center align-items-center">
        <h2 class="category-text">History Subcategories:</h2>
        <div class="button-layout">
          <button id="button-1" class="btn btn-primary" onclick="toggleButton(1)">Ancient History</button>
          <button id="button-2" class="btn btn-primary" onclick="toggleButton(2)">Medieval History</button>
          <button id="button-3" class="btn btn-primary" onclick="toggleButton(3)">World Wars</button>
          <button id="button-4" class="btn btn-primary" onclick="toggleButton(4)">Historical Figures</button>
          <button id="button-5" class="btn btn-primary" onclick="toggleButton(5)">Historical Events</button>
  ...
  <script>
    ...
    function submitForm() {
      ...
      const url = `../feed.php?category=History&subcategory=${encodeURIComponent(selectedSubcategories)}`;
