...
<head>
  ...
  <title>Following - BackYourself</title>  
  <style>
        .main-content {
    ...
    <div class="row">
      ...
      <div class="col-8 main-content">
        ...
        <div class="polls-section">
          ...
          <?php
          // Prepare the query to retrieve polls from users that the active user follows
          $query = "SELECT p.*, u.username FROM polls p
                    INNER JOIN users u ON p.user_id = u.user_id
                    INNER JOIN user_follows f ON f.followed_id = p.user_id
          ...
          if (!empty($polls)) {
            foreach ($polls as $poll) {
              ...
              echo 'There are no posted polls from users you follow.';
          }
          ?>
